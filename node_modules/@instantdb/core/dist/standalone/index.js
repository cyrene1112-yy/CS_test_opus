...
const R = {
  ...
  Replace: "replace",
  Add: "add"
}, An = /* @__PURE__ */ Symbol.for("__MUTATIVE_PROXY_DRAFT__"), gr = /* @__PURE__ */ Symbol("__MUTATIVE_RAW_RETURN_SYMBOL__"), ze = Symbol.iterator, Y = {
  mutable: "mutable",
  immutable: "immutable"
}, Et = {};
function Pe(n, e) {
...
function ne(n, e) {
  if (!n || typeof n != "object")
    return !1;
  let t;
  return Object.getPrototypeOf(n) === Object.prototype || Array.isArray(n) || n instanceof Map || n instanceof Set || !!e?.mark && ((t = e.mark(n, Y)) === Y.immutable || typeof t == "function");
}
function kn(n, e = []) {
  if (Object.hasOwnProperty.call(n, "key")) {
    const t = n.parent.copy, r = k(ce(t, n.key));
    if (r !== null && r?.original !== n.original)
      return null;
    const s = n.parent.type === 3, i = s ? Array.from(n.parent.setMap.keys()).indexOf(n.key) : n.key;
    if (!(s && t.size > i || Pe(t, i)))
      return null;
    e.push(i);
  }
  if (n.parent)
...
function ce(n, e) {
  return ye(n) === 2 ? n.get(e) : n[e];
}
function xe(n, e, t) {
  ye(n) === 2 ? n.set(e, t) : n[e] = t;
}
function rt(n, e) {
  const t = k(n);
  return (t ? J(t) : n)[e];
...
function mr(n, e) {
  for (let t = 0; t < e.length - 1; t += 1) {
    const r = e[t];
    if (n = ce(ye(n) === 3 ? Array.from(n) : n, r), typeof n != "object")
...
function On(n, e) {
  ...
  if (n instanceof Set) {
    ...
    return new Map(n);
  } else if (e?.mark && (t = e.mark(n, Y), t !== void 0) && t !== Y.mutable) {
    if (t === Y.immutable)
      return wr(n);
...
function In(n, e, t) {
  if (pe(n) || !ne(n, t) || e.has(n) || Object.isFrozen(n))
    return;
...
function Sr(n, e) {
  ...
  n.finalities.revoke.length > 1 && n.assignedMap.get(e) && t && In(ce(t, e), n.finalities.handledSet, n.options);
}
function ft(n) {
...
function xt(n, e, t, r) {
  ...
  s && (s.callbacks || (s.callbacks = []), s.callbacks.push((i, o) => {
    ...
    if (ae(ce(c, e), t)) {
      let u = s.original;
      s.copy && (u = s.copy), ft(n), ht(n, r, i, o), n.options.enableAutoFreeze && (n.options.updatedValues = (a = n.options.updatedValues) !== null && a !== void 0 ? a : /* @__PURE__ */ new WeakMap(), n.options.updatedValues.set(u, s.original)), xe(c, e, u);
    }
  }), n.options.enableAutoFreeze && s.finalities !== n.finalities && (n.options.enableAutoFreeze = !1)), ne(t, n.options) && n.finalities.draft.push(() => {
...
function Tr(n, e, t, r, s) {
  ...
  if (i.length < c.length) {
    ...
    if (u) {
      const l = e.concat(["length"]), f = he(l, s);
      r.push({
        op: R.Replace,
        path: f,
        value: i.length
...
function vr({ original: n, copy: e, assignedMap: t }, r, s, i, o) {
  t.forEach((a, c) => {
    const u = ce(n, c), l = We(ce(e, c)), f = a ? Pe(n, c) ? R.Replace : R.Add : R.Remove;
    if (ae(u, l) && f === R.Replace)
      return;
    const d = r.concat(c), h = he(d, o);
...
const Be = (n, e, t = !1) => {
  if (typeof n == "object" && n !== null && (!ne(n, e) || t))
    throw new Error("Strict mode: Mutable data cannot be accessed directly, please use 'unsafe(callback)' wrap.");
}, pt = {
  get size() {
    return J(k(this)).size;
  },
  has(n) {
    return J(k(this)).has(n);
  },
  set(n, e) {
    const t = k(this), r = J(t);
    return (!r.has(n) || !ae(r.get(n), e)) && (z(t), ie(t), t.assignedMap.set(n, !0), t.copy.set(n, e), xt(t, n, e, $e)), this;
  },
  delete(n) {
    if (!this.has(n))
      return !1;
    const e = k(this);
    return z(e), ie(e), e.original.has(n) ? e.assignedMap.set(n, !1) : e.assignedMap.delete(n), e.copy.delete(n), !0;
  },
  clear() {
    const n = k(this);
    if (this.size) {
      z(n), ie(n), n.assignedMap = /* @__PURE__ */ new Map();
  ...
  get(n) {
    var e, t;
    const r = k(this), s = J(r).get(n), i = ((t = (e = r.options).mark) === null || t === void 0 ? void 0 : t.call(e, s, Y)) === Y.mutable;
    if (r.options.strict && Be(s, r.options, i), i || r.finalized || !ne(s, r.options) || s !== r.original.get(n))
      return s;
  ...
  const c = k(a), u = ((s = (r = n.options).mark) === null || s === void 0 ? void 0 : s.call(r, a, Y)) === Y.mutable;
  if (n.options.strict && Be(o, n.options, u), !u && !c && ne(o, n.options) && !n.finalized && n.original.has(o)) {
  ...
  add(n) {
    const e = k(this);
    return this.has(n) || (z(e), ie(e), e.assignedMap.set(n, !0), e.setMap.set(n, n), xt(e, n, n, $e)), this;
  },
  delete(n) {
    if (!this.has(n))
      return !1;
...
const Or = Reflect.ownKeys(Ge), Cn = /* @__PURE__ */ new WeakSet(), En = {
  get(n, e, t) {
    ...
    if (n.options.mark) {
      ...
      if (o = n.options.mark(u, Y), o === Y.mutable)
    ...
    const c = a[e];
    if (n.options.strict && Be(c, n.options), n.finalized || !ne(c, n.options))
      return c;
  ...
  set(n, e, t) {
    ...
    const o = rt(J(n), e), a = k(o);
    return a && ae(a.original, t) ? (n.copy[e] = t, n.assignedMap = (r = n.assignedMap) !== null && r !== void 0 ? r : /* @__PURE__ */ new Map(), n.assignedMap.set(e, !1), !0) : (ae(t, o) && (t !== void 0 || Pe(n.original, e)) || (z(n), ie(n), Pe(n.original, e) && ae(t, n.original[e]) ? n.assignedMap.delete(e) : n.assignedMap.set(e, !0), n.copy[e] = t, xt(n, e, t, $e)), !0);
  },
  has(n, e) {
    return e in J(n);
  },
  ownKeys(n) {
    return Reflect.ownKeys(J(n));
  },
  getOwnPropertyDescriptor(n, e) {
    const t = J(n), r = Reflect.getOwnPropertyDescriptor(t, e);
    return r && {
      writable: !0,
  ...
  deleteProperty(n, e) {
    var t;
    return n.type === 1 ? En.set.call(this, n, e, void 0, n.proxy) : (rt(n.original, e) !== void 0 || e in n.original ? (z(n), ie(n), n.assignedMap.set(e, !1)) : (n.assignedMap = (t = n.assignedMap) !== null && t !== void 0 ? t : /* @__PURE__ */ new Map(), n.assignedMap.delete(e)), n.copy && delete n.copy[e], !0);
  }
};
function Rt(n) {
  const { original: e, parentDraft: t, key: r, finalities: s, options: i } = n, o = ye(e), a = {
    type: o,
    finalized: !1,
    parent: t,
    original: e,
  ...
  if (s.revoke.push(u), Cn.add(c), a.proxy = c, t) {
    ...
    l.finalities.draft.push((f, d) => {
      ...
      const y = ce(g, r), b = k(y);
      if (b) {
        let w = b.original;
        b.operated && (w = jt(y)), ft(b), ht(b, $e, f, d), l.options.enableAutoFreeze && (l.options.updatedValues = (h = l.options.updatedValues) !== null && h !== void 0 ? h : /* @__PURE__ */ new WeakMap(), l.options.updatedValues.set(w, b.original)), xe(g, r, w);
      }
...
function Ir(n, e, t, r, s) {
  var i;
  const o = k(n), a = (i = o?.original) !== null && i !== void 0 ? i : n, c = !!e.length;
  if (o?.operated)
    for (; o.finalities.draft.length > 0; )
      o.finalities.draft.pop()(t, r);
  const u = c ? e[0] : o ? o.operated ? o.copy : o.original : n;
  return o && dt(o), s && we(u, u, o?.options.updatedValues), [
    u,
...
function Cr(n, e) {
  ...
  let s, i;
  e.enablePatches && (s = [], i = []);
  const a = ((t = e.mark) === null || t === void 0 ? void 0 : t.call(e, n, Y)) === Y.mutable || !ne(n, e) ? n : Rt({
    original: n,
    parentDraft: null,
    finalities: r,
    options: e
...
const Er = (n) => function e(t, r, s) {
  ...
  if (typeof t == "function" && typeof r != "function")
    return function(_, ...I) {
      return e(_, (M) => t.call(this, M, ...I), r);
    };
  const c = t, u = r;
  let l = s;
  ...
  const f = pe(c) ? Vt(c) : c, d = Array.isArray(l.mark) ? ((_, I) => {
  ...
  if (!ne(f, g) && typeof f == "object" && f !== null)
  ...
  const P = (_) => {
    const I = k(y);
    if (!pe(_)) {
      if (_ !== void 0 && !ae(_, y) && I?.operated)
        throw new Error("Either the value is returned as a new non-draft value, or only the draft is modified without returning any value.");
      const N = _?.[gr];
      if (N) {
        const V = N[0];
        return g.strict && typeof _ == "object" && _ !== null && yt({
          rootDraft: I,
          value: _,
          useRawReturn: !0
        }), b([V]);
      ...
      if (_ !== void 0)
        return typeof _ == "object" && _ !== null && yt({ rootDraft: I, value: _ }), b([_]);
    }
    if (_ === y || _ === void 0)
      return b([]);
    const M = k(_);
  ...
  return w instanceof Promise ? w.then(P, (_) => {
    throw dt(k(y)), _;
  }) : P(w);
}, He = Er();
...
function xn(n, e, t) {
  ...
  for (const o of e) {
    ...
    l["checked-data-type"] === "date" && t && (u = Ze(u), o[2] = u), Ut(l) && B(i, [u, c, a], o), B(r, [a, c, u], o), B(s, [c, a, u], o);
  }
...
function Un(n, e) {
  if (n)
    return new de(n.attrs, n.linkIndex);
  if (e && "__type" in e)
    return new de(e.attrs, e.linkIndex);
}
function Jr(n, e) {
...
function Ln(n, e, t) {
  ...
  a && (te(n.eav, [s, i, o]), te(n.aev, [i, s, o]), Ut(a) && te(n.vae, [o, i, s]));
}
let Yr = 0;
function Nn(n, e, t) {
  const [r, s, i] = t;
...
function Fn(n, e, t) {
  ...
  const u = ke(n.eav, [s, i, o])?.[3] ?? Nn(n, a, r), l = [s, i, o, u];
  Hr(a) ? (B(n.eav, [s, i], /* @__PURE__ */ new Map([[o, l]])), B(n.aev, [i, s], /* @__PURE__ */ new Map([[o, l]]))) : (B(n.eav, [s, i, o], l), B(n.aev, [i, s, o], l)), Ut(a) && B(n.vae, [o, i, s], l);
}
function Zr(n, e, t) {
  const r = Re(n, t);
  if (!r)
  ...
  B(n.eav, [s, i], /* @__PURE__ */ new Map([[f, d]])), B(n.aev, [i, s], /* @__PURE__ */ new Map([[f, d]]));
}
function gt(n, e, t) {
  const [r, s] = t, i = Re(n, [r]);
  if (!i)
    return;
  ...
  if (a) {
    for (const u of a.keys()) {
      const l = e.getAttr(u);
      l && l["on-delete-reverse"] === "cascade" && G(a.get(u), 1).forEach(
      ...
      l["forward-identity"]?.[1] === s) && (te(n.aev, [u, o]), te(n.eav, [o, u]));
    }
    a.size === 0 && te(n.eav, [o]);
  }
  const c = n.vae.get(o) && G(n.vae.get(o), 2);
  c && c.forEach((u) => {
    const [l, f, d] = u, h = e.getAttr(f);
    (!s || !h || h["reverse-identity"]?.[1] === s) && (te(n.eav, [l, f, d]), te(n.aev, [f, l, d]), te(n.vae, [d, f, l])), h && h["on-delete"] === "cascade" && h["reverse-identity"]?.[1] === s && gt(n, e, [l, h["forward-identity"]?.[1]]);
  }), n.vae.get(o)?.size === 0 && te(n.vae, [o]);
}
function Kn(n, e, t) {
  const r = xn(
    e,
...
function is(n, e, t) {
  ...
  for (const [s, i] of e.entries()) {
    const o = n.eav.get(t)?.get(i.id), a = G(o, 1);
    for (const c of a)
      r[s] = c[2];
  }
  return r;
...
function Nt(n, e) {
  return Array.isArray(e) ? e.map((t) => Nt(n, t)) : us(e) ? n[e] : e;
}
function gs(n, { find: e, where: t }) {
  return mt(n, t).map((s) => Nt(s, e));
}
function ms(n, e, t) {
  return ss(n, Nt(t, e));
}
...
function Qn(n, e, t, r, s) {
  const i = D(e, t, s), o = be(e, t, s), a = i || o;
  if (!a)
    throw new Ae(`Could not find attr for ${[t, s]}`);
  if (a["value-type"] !== "ref")
...
function Zs(n, e, t) {
  ...
  for (const s of t.fields) {
    const i = D(n, e, s), o = i?.["forward-identity"]?.[2];
    o && Lt(i) && r.set(o, i);
  }
  if (!r.has("id")) {
    const s = D(n, e, "id"), i = s?.["forward-identity"]?.[2];
    i && r.set(i, s);
  }
  return r;
}
function Xs(n, e, { etype: t, pageInfo: r, dq: s, form: i }) {
  ...
  u.sort(
    c === "asc" ? function(g, y) {
      return Je(g, y, d?.["checked-data-type"]);
    } : function(g, y) {
      return Je(y, g, d?.["checked-data-type"]);
    }
  );
  let h = {};
  const p = Zs(e, t, s);
  for (const m of u) {
    const [g] = m;
    if (h[g] || !a && l && d && Bs(l, d, c, m) || f && d && Gs(f, d, c, m))
      continue;
    const y = is(n, p, g);
    y && (h[g] = y);
  }
...
function fi(n, e, t) {
  if (!di(n, e, t))
    return D(n, e, t);
  const r = Tt(t), s = D(n, e, r) || be(n, e, r);
...
function hi({ attrsStore: n }, [e, t, r]) {
  const s = Object.entries(r).flatMap(([i, o]) => {
    const a = Array.isArray(o) ? o : [o], c = D(n, e, i), u = be(n, e, i);
    return a.map((l) => c ? [
      "add-triple",
      H(n, e, t),
      c.id,
      ...
      // already exist
      H(n, c["reverse-identity"][1], l)
    ] : [
      "add-triple",
      // Uses `!` because if we get here, we should have created the attr if it doesn't
      // already exist
      H(n, u["forward-identity"][1], l),
      u?.id,
      H(n, e, t)
    ]);
  });
...
function bi(n, e) {
  const { attrsStore: t } = n, [r, s, i, o] = e, a = Dt(i), c = H(t, r, s);
...
function gi(n, e) {
  const { attrsStore: t } = n, [r, s, i, o] = e, a = Dt(i), c = H(t, r, s), u = Xn(n, [r, c, i, o]);
...
function mi({ attrsStore: n }, [e, t]) {
  return [["delete-entity", H(n, e, t), e]];
}
function wi(n, e) {
  const { attrsStore: t } = n, [r, s, i, o] = e, a = Dt(i), c = H(t, r, s), u = Xn(n, [r, c, i, o]), l = Object.entries(a).map(([d, h]) => {
    const p = D(t, r, d);
    return [
      "deep-merge-triple",
      c,
...
function _i({ attrsStore: n }, [e, t, r]) {
  return [["rule-params", H(n, e, t), e, r]];
}
function Si(n) {
  const [e, t, r, s, i] = n;
  if (!s)
...
function Ne(n, e, t, r) {
  const s = n ? Ai(n, e, t) : null, i = $(), a = [$(), e, t];
  return {
    id: i,
    "forward-identity": a,
    "value-type": "blob",
...
function Oi(n, e, t) {
  ...
  return {
    "forward-identity": [$(), s.on, s.label],
    "reverse-identity": [$(), i.on, i.label],
...
function nn(n, e, t, r) {
  const s = n ? Oi(n, e, t) : null, i = $(), o = [$(), e, t], a = [$(), t, e];
  return {
    id: i,
...
class kt {
  ...
  async _initMeta() {
    ...
    try {
      const e = this._persister.getItem(Se);
  ...
  async clearUnloadedKeys() {
    ...
    for (const t of await this._persister.getAllKeys())
      t === Se || t in this.currentValue || (this._pendingSaveKeys.add(t), e = !0);
...
async function Ni(n, e, t) {
  ...
  return new Promise((i, o) => {
    ...
    const c = { objects: a }, u = t.put(c, Se);
    s.add(u);
    for (const l of s)
      l.onsuccess = () => {
...
async function Fi(n, e) {
  ...
  const r = await new Promise((l, f) => {
    ...
    p.onsuccess = () => {
      const g = p.result;
      if (g) {
        const y = g.key, b = g.value;
        m.push([y, b]), g.continue();
      } else
        l(m);
    }, p.onerror = (g) => {
      f(g);
  ...
  _init() {
    return new Promise((e, t) => {
      ...
      s.onerror = (i) => {
        ...
        if (r) {
          const c = Fi(this._appId, a).catch((u) => {
...
class De extends K {
  ...
  constructor(e) {
    ...
    Object.setPrototypeOf && Object.setPrototypeOf(this, r), Error.captureStackTrace && Error.captureStackTrace(this, De), this.name = "InstantAPIError", this.status = e.status, this.body = e.body;
  }
  get [Symbol.toStringTag]() {
...
function Ki({
  ...
  return re(`${n}/runtime/auth/send_magic_code`, {
    method: "POST",
...
async function qi({
  ...
  return await re(`${n}/runtime/auth/verify_magic_code`, {
    method: "POST",
    headers: { "content-type": "application/json" },
    body: JSON.stringify({
      "app-id": e,
...
async function zi({
  ...
  return await re(`${n}/runtime/auth/verify_refresh_token`, {
    method: "POST",
    headers: { "content-type": "application/json" },
    body: JSON.stringify({
      "app-id": e,
...
async function Wi({
  ...
  return await re(`${n}/runtime/auth/sign_in_guest`, {
    method: "POST",
    headers: { "content-type": "application/json" },
    body: JSON.stringify({
      "app-id": e
...
async function an({
  ...
  return await re(`${n}/runtime/oauth/token`, {
    method: "POST",
    headers: { "content-type": "application/json" },
    body: JSON.stringify({
      app_id: e,
...
async function Vi({
  ...
  return await re(`${n}/runtime/oauth/id_token`, {
    method: "POST",
    headers: { "content-type": "application/json" },
    body: JSON.stringify({
      app_id: e,
...
async function Qi({
  ...
  return await re(`${n}/runtime/signout`, {
    method: "POST",
    headers: {
...
async function Bi({
  ...
  return o && (a["content-disposition"] = o), await re(`${n}/storage/upload`, {
    method: "PUT",
    headers: a,
    body: r
  });
...
async function Hi({
  ...
  const { data: i } = await re(`${n}/storage/signed-upload-url`, {
    method: "POST",
    headers: {
      "content-type": "application/json",
      authorization: `Bearer ${r}`
...
}, hn = (n) => typeof n != "string" ? !1 : Ye(n) ? !0 : ve(n);
class Z extends Error {
  constructor(e) {
    super(e), this.name = "TransactionValidationError";
  }
}
const lr = (n) => n.length > 0 ? n.join(", ") : "none", io = (n, e) => new Z(
...
function go(n, e) {
  ...
  const t = n.orderField === "serverCreatedAt" ? "number" : D(e(), n.table, n.orderField)?.["checked-data-type"];
  ...
  onSyncUpdateTriples(e) {
    ...
    for (const o of e.txes) {
      ...
      for (const m of o.changes) {
        const g = c[m.triple[0]] ?? [];
        c[m.triple[0]] = g, g.push(m);
      }
      const u = s.values ?? {
        entities: [],
        attrsStore: this.getAttrs()
      ...
      e: for (const [m, g] of Object.entries(c))
        for (let y = 0; y < l.length; y++) {
          const b = l[y];
          if (Jr(b.store, m)) {
            gn(b.store, u.attrsStore, g);
            const w = ot(s, b.store, u.attrsStore), P = bo(
              b.store,
              u.attrsStore,
              g
            )[m];
...
function So({
  ...
  function T(S) {
    let O = g, q = 0, Q = 0;
    for (const { byteLen: ee } of b) {
      const oe = O + ee;
      if (oe > S)
        break;
      O = oe, q++, Q += ee;
    }
    q > 0 && (g += Q, y -= Q, b.splice(0, q));
  }
  function v(S, O) {
    a = O, P(), S.error(O), M();
  }
  async function A() {
    ...
    switch (S.type) {
      case "ok": {
        const { streamId: O, offset: q } = S;
        o = O, T(q), b.length && r({
          streamId: O,
          chunks: b.map((Q) => Q.chunk),
          offset: g
        }), m = !1;
        break;
      }
  ...
  async function X(S) {
    ...
    let O = !0, q = 0;
    for (; O; ) {
      let Q = Date.now() + Math.min(15e3, 500 * (q - 1));
      O = !1;
      const ee = await t({
        clientId: e.clientId,
        reconnectToken: u,
      ...
      switch (ee.type) {
        case "ok": {
          const { streamId: oe, offset: nt } = ee;
          if (nt !== 0) {
            const fe = new K("Write stream is corrupted");
            v(S, fe);
            return;
          }
          V(oe), s(oe, {
            onDisconnect: ue,
            onFlush: j,
            onConnectionReconnect: A,
            onAppendFailed: C
          }), m = !1;
          return;
        }
        case "disconnect": {
          O = !0, ue(), q++, await new Promise((oe) => {
            setTimeout(oe, Math.max(0, Q - Date.now()));
          });
          break;
        }
        case "error": {
    ...
    async streamId() {
      return o || new Promise((O, q) => {
        const Q = [], ee = () => {
          ...
          q(fe || new K("Stream is closed.")), ee();
        };
        Q.push(N(oe)), Q.push(_(nt));
      });
    }
  }
  return {
    stream: new le({
      ...
      write(S, O) {
        const q = U(O);
        if (q) {
          const Q = w.encode(S).length;
          b.push({ chunk: S, byteLen: Q });
          const ee = g + y;
          y += Q, m || r({ streamId: q, chunks: [S], offset: ee });
        }
      },
      close() {
        o ? r({
...
function vo({
  ...
  async function m(b, w) {
    ...
    for await (const _ of t(P)) {
      ...
      if (_.offset > s) {
        h(w, new K("Stream is corrupted.")), i = !0;
        return;
      }
      let I = s - _.offset;
      if (_.files && _.files.length) {
        const M = new AbortController();
        let N = fetch(_.files[0].url, {
          signal: M.signal
        });
        for (let V = 0; V < _.files.length; V++) {
          const ue = _.files[V + 1], v = await N;
          if (ue && (N = fetch(ue.url, { signal: M.signal })), !v.ok) {
            if (p++, p > 10) {
              h(w, new K("Unable to process stream."));
              return;
            }
            return { retry: !0 };
          }
          if (v.body) {
            const A = v.body.getReader();
            try {
              for (; ; ) {
                ...
                let U = j;
                if (I > 0 && (U = j.subarray(I), I -= j.length - U.length), !U.length)
                  continue;
                s += U.length;
                const X = o.decode(U);
                w.enqueue(X);
            ...
            if (I > 0 && (C = new Uint8Array(A).subarray(I), I -= A.byteLength - C.length), !C.byteLength)
              continue;
            s += C.byteLength;
            const j = o.decode(C);
            w.enqueue(j);
      ...
      if (p = 0, _.content) {
        let M = _.content, N = a.encode(_.content);
        if (I > 0) {
          const V = N.subarray(I);
          if (I -= N.length - V.length, !V.length)
            continue;
          N = V, M = o.decode(V);
        }
        s += N.length, w.enqueue(M);
      }
    }
  }
  async function g(b) {
    ...
    for (; w; ) {
      w = !1;
      let _ = Date.now() + Math.min(15e3, 500 * (P - 1));
      (await m(
        { ...e, offset: s },
        b
      ))?.retry && (w = !0, P++, _ < Date.now() - 3e5 && (P = 0), await new Promise((M) => {
        setTimeout(M, Math.max(0, _ - Date.now()));
      }));
    }
    !i && !u && (b.close(), f());
  }
...
class Ao {
  ...
  appendStream({
    ...
    i && (o["abort-reason"] = i), this.trySend($(), o);
  }
  onAppendFailed(e) {
  ...
  cancelReadStream({ eventId: e }) {
    ...
    this.trySend($(), t), delete this.readStreamIterators[e];
  }
  onStreamAppend(e) {
    ...
    (e.files?.length || e.content) && r.push({
      type: "append",
      offset: e.offset,
      files: e.files,
      content: e.content
...
}, at = "_instant_oauth_redirect", ct = "_instant_extra_fields_id", Ke = "oauthExtraFields", ge = "currentUser";
function Mo({
  transportType: n,
  appId: e,
  apiURI: t,
...
class Uo {
  ...
  _addQueryData(e, t, r) {
    ...
    const s = L(e), i = this.ensureAttrs(), o = _e(
      this.attrs,
      t.triples,
      r,
      this.config.useDateObjects
  ...
  _handleReceive(e, t) {
    ...
    switch (mn[t.op] || this._log.info("[receive]", e, t.op, t), t.op) {
      case "init-ok": {
        this._setStatus(se.AUTHENTICATED), this._reconnectTimeoutMs = 0, this._setAttrs(t.attrs), this._flushPendingMessages(), this._sessionId = t["session-id"];
      ...
      case "add-query-ok": {
        ...
        if (!this._hasQueryListeners() && !this.querySubs.currentValue[c])
          break;
        const u = a?.[0]?.data?.["page-info"], l = a?.[0]?.data?.aggregate, f = ln(a), d = this.ensureAttrs(), h = _e(
          d,
          f,
          r,
          this.config.useDateObjects
      ...
      case "refresh-ok": {
        ...
        const l = ut(u.entries()), f = o.map((d) => {
          const h = d["instaql-query"], p = d["instaql-result"], m = L(h), g = ln(p), y = this.ensureAttrs(), b = _e(
            y,
            g,
            r,
            this.config.useDateObjects
          ), { store: w, attrsStore: P } = this._applyOptimisticUpdates(
            b,
            y,
            l,
            c
          ), _ = p?.[0]?.data?.["page-info"], I = p?.[0]?.data?.aggregate;
          return {
            q: h,
            hash: m,
            store: w,
        ...
        f.forEach(
          ({ hash: d, q: h, store: p, attrsStore: m, pageInfo: g, aggregate: y }) => {
...
`,
  ...
  _cleanupQuery(e, t) {
    this._hasQueryListeners(t) || (delete this.queryCbs[t], delete this.queryOnceDfds[t], delete this._dataForQueryCache[t], this.querySubs.unloadKey(t), this._trySendAuthed($(), { op: "remove-query", q: e }));
  }
  ...
  optimisticAttrs() {
    ...
    if (!t.size && !r.length)
      return this.attrs || new de({}, this._linkIndex);
    const s = { ...this.attrs?.attrs || {} };
    for (const i of r)
      s[i.id] = i;
    for (const i of t)
      delete s[i];
    return new de(s, this._linkIndex);
  }
  ...
  dataForQuery(e, t = !0) {
    ...
    const { pageInfo: h, aggregate: p, processedTxId: m } = u, g = this._rewriteMutationsSorted(
      d,
      a
    );
    if (t) {
   ...
   */
  pushOps = (e, t) => {
    const r = $(), s = [...this._pendingMutations().values()], i = Math.max(0, ...s.map((c) => c.order || 0)) + 1, o = {
      op: "transact",
      "tx-steps": e,
      created: Date.now(),
      error: t,
  ...
  async _getCurrentUser(e) {
    e?.forceReadFromStorage && await this.kv.unloadKey(ge);
  ...
  _tryLeaveRoom(e) {
    this._trySendAuthed($(), { op: "leave-room", "room-id": e });
  }
      ...
      if (a.topics)
        for (const [l, f] of Object.entries(a.topics)) {
          ...
          for (const [p, m] of Object.entries(d.attrs)) {
            ...
            g.required || (y = y.optional()), g.config?.indexed && (y = y.indexed()), g.config?.unique && (y = y.unique()), h[p] = y;
          }
          u[l] = x.entity(h);
        }
      r[i] = {
...
class Sa {
  ...
  completeIsomorphic = (e, t, r, s) => {
    ...
    const o = !!this.db?._reactor?.config?.schema && ("cardinalityInference" in this.db?._reactor?.config ? !!this.db?._reactor.config?.cardinalityInference : !0), a = new de(
    ...
    try {
      ...
      if (!t.ok)
        try {
          ...
          throw "message" in a ? new De({ body: a, status: t.status }) : new Error("Error getting triples from server");
        } catch (a) {
...
const na = (n) => JSON.stringify(n), Me = (n, e = !1) => JSON.stringify([n, e]), _n = (n) => {
  const [e, t] = JSON.parse(n);
  return { cursor: e, afterInclusive: t };
}, me = (n, e, t = !1) => `${n}:${Me(e, t)}`, ra = (n) => !!n.endCursor, sa = (n) => {
  ...
  const g = (T) => {
    ...
    u.set(Me(T, v.afterInclusive), v), y();
  }, w = (T, v) => {
    l.set(Me(T), v), N(), y();
  }, P = (T, v) => {
    const { cursor: A } = _n(T);
    ...
    const j = n.subscribeQuery(
      ...
      (U) => {
        if (U.error)
          return g(U.error);
        const X = U.data[a], le = U.pageInfo[a];
        Oe(
          X && le,
    ...
    f.set(me("reverse", A), j);
  }, _ = (T) => {
    const v = n.subscribeQuery(
      {
        [a]: {
          ...i,
          $: {
      ...
      (A) => {
        if (A.error)
          return g(A.error);
        const C = A.data[a], j = A.pageInfo[a];
        Oe(C && j, "Expected rows and pageInfo"), w(T, {
          data: C,
    ...
    const A = n.subscribeQuery(
      ...
      (C) => {
        if (C.error)
          return g(C.error);
        const j = C.data[a], U = C.pageInfo[a];
        Oe(j && U, "Page info and rows"), b(T, {
          data: j,
          status: "bootstrapping",
    ...
    const j = u.get(A);
    if (!j?.endCursor) return;
    const U = n.subscribeQuery(
      {
        [a]: {
          ...i,
          $: {
            after: T,
            afterInclusive: j.afterInclusive,
            before: j.endCursor,
            beforeInclusive: !0,
            where: i.$?.where,
            fields: i.$?.fields,
      ...
      (X) => {
        if (X.error)
          return g(X.error);
        const le = X.data[a], Ue = X.pageInfo[a];
        Oe(le && Ue, "Expected rows and pageInfo"), b(T, {
          data: le,
          status: "frozen",
          hasMore: Ue.hasNextPage,
          endCursor: Ue.endCursor,
          afterInclusive: j.afterInclusive
        });
      },
      r
    );
    f.set(me("forward", T, v), U);
  }, N = () => {
    const T = Array.from(l.entries()).at(-1);
    if (!T) return;
    const [v, A] = T;
    if (!A?.hasMore || !ra(A)) return;
    const C = `${v}:${na(A.endCursor)}`;
    C != p && (p = C, P(v, A), _(A.endCursor));
  }, V = () => {
    const T = Array.from(u.entries()).at(-1);
    if (!T) return;
    const [v, A] = T;
    if (!A.endCursor) return;
    const { cursor: C, afterInclusive: j } = _n(v);
    M(C, j), I(A.endCursor);
  };
  return m = n.subscribeQuery(
    ...
    async (T) => {
      ...
      if (T.error)
        return g(T.error);
      const v = T.pageInfo[a], A = T?.data?.[a];
      if (Oe(A && v, "Expected rows and pageInfo"), A.length < o) {
        b(lt, {
          data: A,
      ...
      u.delete(Me(lt)), I(C, !0), _(v.startCursor), d = !0;
    },
    r
  ), {
    unsubscribe: () => {
  ...
  if (!t || !r)
    throw new E("No query provided for infinite query");
...
export {
  ...
  Z as TransactionValidationError,
